...
diag_lines = [
    ...
    "        # Simple top-2 peak detection: find the two absolute highest points on the projection",
    "        min_sep_x = int(w_img * 0.1); min_sep_y = int(h_img * 0.1)",
    ...
    "    print(Sid + ': ' + str([[int(v[0]),int(v[1])] for v in quad]))",
]
